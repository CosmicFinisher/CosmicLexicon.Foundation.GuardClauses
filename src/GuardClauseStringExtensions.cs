    ...
    public static class GuardClauseStringExtensions
    {
       ...
       private static readonly Regex UrlRegex = new(
        ...
        extension(IGuardClause guard)
        {
            ...
            public void InvalidFormat(string input, string regexPattern, [CallerArgumentExpression("input")] string? parameterName = null)
            {
            ...
            /// <param name="parameterName">The name of the parameter, captured automatically by <see cref="CallerArgumentExpressionAttribute"/>.</param>
            /// <exception cref="ArgumentException">Thrown if <paramref name="input"/> does not match the <paramref name="regexPattern"/>.</exception>
            public void InvalidFormat(string input, string regexPattern, string userMessage, [CallerArgumentExpression("input")] string? parameterName = null)
            {
            ...
            public void InvalidEmail(string input, [CallerArgumentExpression("input")] string? parameterName = null)
            {
            ...
            public void InvalidUrl(string input, [CallerArgumentExpression("input")] string? parameterName = null)
            {
                if (string.IsNullOrWhiteSpace(input))
                {
                    return;
            ...
            public void NullOrEmpty([NotNull] string? input, [CallerArgumentExpression("input")] string? parameterName = null)
            {
                if (input is null)
                {
            ...
            public void NullOrWhiteSpace([NotNull] string? input, [CallerArgumentExpression("input")] string? parameterName = null)
            {
                if (input is null)
                {
                    throw new ArgumentNullException(parameterName);
