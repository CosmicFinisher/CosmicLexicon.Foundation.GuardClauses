namespace CosmicLexicon.Foundation.GuardClauses
{
    ...
    public static class GuardClauseObjectExtensions
    {
        extension(IGuardClause guard)
        {
            ...
            public void Null<T>(T? input, [CallerArgumentExpression("input")] string? parameterName = null) where T : class
            {
                if (input == null)
                {
            ...
            public void NotFound(object? input, [CallerArgumentExpression("input")] string? parameterName = null)
            {
                if (input == null)
                {
            ...
            public void NullOrEmpty<T>(IEnumerable<T>? input, [CallerArgumentExpression("input")] string? parameterName = null)
            {
                if (input == null)
                {
            ...
            public void OutOfRange(DateTime input, DateTime minimum, DateTime maximum, [CallerArgumentExpression("input")] string? parameterName = null)
            {
